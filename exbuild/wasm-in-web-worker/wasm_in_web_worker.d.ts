...
declare interface InitOutput {
    ...
    readonly wasm_bindgen__closure__destroy__hc92fe335dbe3f3be: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__he8932f2b94bf70cb: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h0759c2f6bc9dc989: (a: number, b: number) => void;
