...
declare interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h8a52fb8a7153854b: (a: number, b: number) => void;
  readonly wasm_bindgen__closure__destroy__hb04988d6c65160df: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures_____invoke__h6252294ec64f76db: (a: number, b: number, c: any) => void;
