...
- `just test-cli-overwrite` - Run CLI tests overwriting reference tests (must be run with the `stable` Rust toolchain, matching CI, or you will get spurious unrelated diffs)
