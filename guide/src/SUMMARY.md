...
- [Examples](./examples/index.md)
  ...
  - [JSPI + OPFS](./examples/jspi-opfs.md)
- [Reference](./reference/index.md)
  - [Working with Generics](./reference/working-with-generics.md)
  ...
  - [JSPI — JS Promise Integration](./reference/jspi.md)
  ...
  - [Supported Types](./reference/types.md)
    ...
    - [`js-sys`](./reference/types/js-sys.md)
