...
with execution identity symbols to then validate and throws for stale references,
...
```javascript
// Before handling a new request in a reused context
__wbg_reset_state();

// Now safe to use WebAssembly bindings again
