...
//! `#[wasm_bindgen(experimental_generic_mono)]` imports: a type or lifetime parameter
...
extern "C" {
    ...
    #[wasm_bindgen(static_method_of = Holder, experimental_generic_mono, js_name = of)]
    fn holder_of<T>(value: T) -> Holder<T>;

    // The default generic-erasure path shares class-impl assembly with
    // `experimental_generic_mono`; exercise it at runtime so that refactor cannot only
    ...
    #[wasm_bindgen(method, experimental_generic_mono, js_name = combine)]
    ...
    #[wasm_bindgen(static_method_of = LtHolder, experimental_generic_mono, js_name = of)]
    ...
    #[wasm_bindgen(method, experimental_generic_mono, js_name = swap)]
    ...
    #[wasm_bindgen(method, experimental_generic_mono, js_name = both)]
    ...
    #[wasm_bindgen(method, experimental_generic_mono, js_name = key)]
    ...
    #[wasm_bindgen(method, experimental_generic_mono, js_name = tag)]
    ...
    #[wasm_bindgen(method, experimental_generic_mono, js_name = nestedGet)]
    ...
    // RFC 447).
    #[wasm_bindgen(method, experimental_generic_mono, js_name = whereBound)]
    ...
    #[wasm_bindgen(method, experimental_generic_mono, js_name = first)]
    ...
    #[wasm_bindgen(constructor, experimental_generic_mono, catch)]
...
#[wasm_bindgen_test]
fn experimental_generic_mono_class_generic_constructor_and_get() {
...
#[wasm_bindgen_test]
fn experimental_generic_mono_class_generic_static_self_returning_method() {
...
#[wasm_bindgen_test]
fn experimental_generic_mono_class_generic_mixed_hoisted_and_non_hoisted_param() {
...
#[wasm_bindgen_test]
fn experimental_generic_mono_class_lifetime_only_parameter() {
...
#[wasm_bindgen_test]
fn experimental_generic_mono_class_lifetime_and_type_param() {
...
#[wasm_bindgen_test]
fn experimental_generic_mono_class_two_generic_params() {
...
#[wasm_bindgen_test]
fn experimental_generic_mono_class_concrete_generic_arguments() {
    let pair = Pair::new_pair(1u32, String::from("one"));
...
#[wasm_bindgen_test]
fn experimental_generic_mono_class_generic_param_unused_in_signature() {
...
#[wasm_bindgen_test]
fn experimental_generic_mono_class_generic_composed_argument() {
    let boxed: Boxed<Option<u32>> = Boxed::new_boxed(3u32, Some(5u32));
    assert_eq!(boxed.boxed_nested_get(), 3);
}

#[wasm_bindgen_test]
fn experimental_generic_mono_class_generic_where_bound() {
...
#[wasm_bindgen_test]
fn experimental_generic_mono_class_generic_where_bound_projection() {
...
#[wasm_bindgen_test]
fn experimental_generic_mono_class_generic_catch_constructor() {
