...
fn test_numeric_value_slots() {
    test_generic_ref(&42i32, "number");
    test_generic_ref(&123u32, "number");
    test_generic_ref(&3.14f32, "number");
    test_generic_ref(&2.718f64, "number");
}

#[wasm_bindgen_test]
fn test_bigint_value_slots() {
    test_generic_ref(&9223372036854775807i64, "bigint");
    test_generic_ref(&18446744073709551615u64, "bigint");
}

#[wasm_bindgen_test]
fn test_string_value_slots() {
    test_generic_ref(&'🦀', "string");
}

#[wasm_bindgen_test]
fn test_bool_value_slots() {
    test_generic_ref(&true, "boolean");
}
