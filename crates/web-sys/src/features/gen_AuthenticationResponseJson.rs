...
extern "C" {
    ...
    pub fn set_id<S0: ::wasm_bindgen::JsStringLike>(this: &AuthenticationResponseJson, val: S0);
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn set_raw_id<S0: ::wasm_bindgen::JsStringLike>(this: &AuthenticationResponseJson, val: S0);
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn set_type<S0: ::wasm_bindgen::JsStringLike>(this: &AuthenticationResponseJson, val: S0);
}
#[cfg(web_sys_unstable_apis)]
