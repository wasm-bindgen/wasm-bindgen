...
extern "C" {
    ...
    #[cfg(all(feature = "FileSystemHandle", feature = "JsOption",))]
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `DataTransferItem`, `FileSystemHandle`, `JsOption`*"]
    #[doc = ""]
