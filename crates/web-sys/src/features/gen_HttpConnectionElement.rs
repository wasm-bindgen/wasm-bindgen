...
extern "C" {
    ...
    #[doc = "Like `get_host()`, but returning a `js_sys::JsString` handle to the string rather than copying it into wasm memory."]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `HttpConnectionElement`*"]
    #[wasm_bindgen(method, getter = "host")]
    pub fn get_host_js_string(this: &HttpConnectionElement) -> Option<::js_sys::JsString>;
