...
extern "C" {
    ...
    #[doc = "*This API requires the following crate features to be activated: `TokenBinding`*"]
    #[wasm_bindgen(method, getter = "id")]
    pub fn get_id_js_string(this: &TokenBinding) -> Option<::js_sys::JsString>;
    ...
    #[doc = "Like `get_status()`, but returning a `js_sys::JsString` handle to the string rather than copying it into wasm memory."]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `TokenBinding`*"]
    #[wasm_bindgen(method, getter = "status")]
    pub fn get_status_js_string(this: &TokenBinding) -> ::js_sys::JsString;
