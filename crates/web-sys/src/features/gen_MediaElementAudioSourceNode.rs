...
impl ::wasm_bindgen::convert::Upcast<AudioNode> for MediaElementAudioSourceNode {}
#[automatically_derived]
impl ::wasm_bindgen::convert::Upcast<EventTarget> for MediaElementAudioSourceNode {}
