...
extern "C" {
    ...
    #[cfg(web_sys_unstable_apis)]
    #[wasm_bindgen(method, getter, js_class = "FontData", js_name = "postscriptName")]
    #[doc = "Like `postscript_name()`, but returning a `js_sys::JsString` handle to the string rather than copying it into wasm memory."]
    #[doc = ""]
    #[doc = "[MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/API/FontData/postscriptName)"]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `FontData`*"]
    ...
    #[doc = "*This API is unstable and requires `--cfg=web_sys_unstable_apis` to be activated, as"]
    #[doc = "[described in the `wasm-bindgen` guide](https://wasm-bindgen.github.io/wasm-bindgen/web-sys/unstable-apis.html)*"]
    pub fn postscript_name_js_string(this: &FontData) -> ::js_sys::JsString;
    #[cfg(web_sys_unstable_apis)]
    ...
    #[cfg(web_sys_unstable_apis)]
    #[wasm_bindgen(method, getter, js_class = "FontData", js_name = "fullName")]
    #[doc = "Like `full_name()`, but returning a `js_sys::JsString` handle to the string rather than copying it into wasm memory."]
    #[doc = ""]
    #[doc = "[MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/API/FontData/fullName)"]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `FontData`*"]
    ...
    #[doc = "*This API is unstable and requires `--cfg=web_sys_unstable_apis` to be activated, as"]
    #[doc = "[described in the `wasm-bindgen` guide](https://wasm-bindgen.github.io/wasm-bindgen/web-sys/unstable-apis.html)*"]
    pub fn full_name_js_string(this: &FontData) -> ::js_sys::JsString;
    #[cfg(web_sys_unstable_apis)]
    ...
    #[doc = "*This API is unstable and requires `--cfg=web_sys_unstable_apis` to be activated, as"]
    #[doc = "[described in the `wasm-bindgen` guide](https://wasm-bindgen.github.io/wasm-bindgen/web-sys/unstable-apis.html)*"]
    pub fn family_js_string(this: &FontData) -> ::js_sys::JsString;
    #[cfg(web_sys_unstable_apis)]
    ...
    #[doc = "*This API is unstable and requires `--cfg=web_sys_unstable_apis` to be activated, as"]
    #[doc = "[described in the `wasm-bindgen` guide](https://wasm-bindgen.github.io/wasm-bindgen/web-sys/unstable-apis.html)*"]
    pub fn style_js_string(this: &FontData) -> ::js_sys::JsString;
    #[cfg(web_sys_unstable_apis)]
    #[cfg(feature = "Blob")]
