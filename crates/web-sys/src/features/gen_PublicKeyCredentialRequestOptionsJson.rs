...
extern "C" {
    ...
    #[doc = "[described in the `wasm-bindgen` guide](https://wasm-bindgen.github.io/wasm-bindgen/web-sys/unstable-apis.html)*"]
    #[wasm_bindgen(method, getter = "challenge")]
    pub fn get_challenge_js_string(
        this: &PublicKeyCredentialRequestOptionsJson,
    ) -> ::js_sys::JsString;
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn set_rp_id<S0: ::wasm_bindgen::JsStringLike>(
        this: &PublicKeyCredentialRequestOptionsJson,
        val: S0,
    );
    #[cfg(web_sys_unstable_apis)]
    ...
    #[cfg(web_sys_unstable_apis)]
    #[doc = "Like `get_user_verification()`, but returning a `js_sys::JsString` handle to the string rather than copying it into wasm memory."]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `PublicKeyCredentialRequestOptionsJson`*"]
    #[doc = ""]
    #[doc = "*This API is unstable and requires `--cfg=web_sys_unstable_apis` to be activated, as"]
    #[doc = "[described in the `wasm-bindgen` guide](https://wasm-bindgen.github.io/wasm-bindgen/web-sys/unstable-apis.html)*"]
    #[wasm_bindgen(method, getter = "userVerification")]
    pub fn get_user_verification_js_string(
        this: &PublicKeyCredentialRequestOptionsJson,
    ) -> Option<::js_sys::JsString>;
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn set_user_verification<S0: ::wasm_bindgen::JsStringLike>(
        this: &PublicKeyCredentialRequestOptionsJson,
        val: S0,
    );
}
...
impl PublicKeyCredentialRequestOptionsJson {
    ...
    #[doc = "*This API is unstable and requires `--cfg=web_sys_unstable_apis` to be activated, as"]
    #[doc = "[described in the `wasm-bindgen` guide](https://wasm-bindgen.github.io/wasm-bindgen/web-sys/unstable-apis.html)*"]
    pub fn new<S0: ::wasm_bindgen::JsStringLike>(challenge: S0) -> Self {
        #[allow(unused_mut)]
    ...
    pub fn rp_id<S0: ::wasm_bindgen::JsStringLike>(&mut self, val: S0) -> &mut Self {
        self.set_rp_id(val);
        self
    }
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn user_verification<S0: ::wasm_bindgen::JsStringLike>(&mut self, val: S0) -> &mut Self {
