...
extern "C" {
    ...
    #[doc = "Like `get_method_name()`, but returning a `js_sys::JsString` handle to the string rather than copying it into wasm memory."]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `PaymentMethodChangeEventInit`*"]
    #[wasm_bindgen(method, getter = "methodName")]
    pub fn get_method_name_js_string(this: &PaymentMethodChangeEventInit) -> ::js_sys::JsString;
