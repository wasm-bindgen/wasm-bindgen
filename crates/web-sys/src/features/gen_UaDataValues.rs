...
extern "C" {
    ...
    #[cfg(web_sys_unstable_apis)]
    #[doc = "Like `get_architecture()`, but returning a `js_sys::JsString` handle to the string rather than copying it into wasm memory."]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `UaDataValues`*"]
    #[doc = ""]
    #[doc = "*This API is unstable and requires `--cfg=web_sys_unstable_apis` to be activated, as"]
    #[doc = "[described in the `wasm-bindgen` guide](https://wasm-bindgen.github.io/wasm-bindgen/web-sys/unstable-apis.html)*"]
    #[wasm_bindgen(method, getter = "architecture")]
    pub fn get_architecture_js_string(this: &UaDataValues) -> Option<::js_sys::JsString>;
    #[cfg(web_sys_unstable_apis)]
    ...
    #[cfg(web_sys_unstable_apis)]
    #[doc = "Like `get_bitness()`, but returning a `js_sys::JsString` handle to the string rather than copying it into wasm memory."]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `UaDataValues`*"]
    #[doc = ""]
    #[doc = "*This API is unstable and requires `--cfg=web_sys_unstable_apis` to be activated, as"]
    #[doc = "[described in the `wasm-bindgen` guide](https://wasm-bindgen.github.io/wasm-bindgen/web-sys/unstable-apis.html)*"]
    #[wasm_bindgen(method, getter = "bitness")]
    pub fn get_bitness_js_string(this: &UaDataValues) -> Option<::js_sys::JsString>;
    #[cfg(web_sys_unstable_apis)]
    ...
    #[cfg(web_sys_unstable_apis)]
    #[doc = "Like `get_model()`, but returning a `js_sys::JsString` handle to the string rather than copying it into wasm memory."]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `UaDataValues`*"]
    #[doc = ""]
    #[doc = "*This API is unstable and requires `--cfg=web_sys_unstable_apis` to be activated, as"]
    #[doc = "[described in the `wasm-bindgen` guide](https://wasm-bindgen.github.io/wasm-bindgen/web-sys/unstable-apis.html)*"]
    #[wasm_bindgen(method, getter = "model")]
    pub fn get_model_js_string(this: &UaDataValues) -> Option<::js_sys::JsString>;
    #[cfg(web_sys_unstable_apis)]
    ...
    #[doc = "[described in the `wasm-bindgen` guide](https://wasm-bindgen.github.io/wasm-bindgen/web-sys/unstable-apis.html)*"]
    #[wasm_bindgen(method, getter = "platform")]
    pub fn get_platform_js_string(this: &UaDataValues) -> Option<::js_sys::JsString>;
    #[cfg(web_sys_unstable_apis)]
    ...
    #[cfg(web_sys_unstable_apis)]
    #[doc = "Like `get_platform_version()`, but returning a `js_sys::JsString` handle to the string rather than copying it into wasm memory."]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `UaDataValues`*"]
    #[doc = ""]
    #[doc = "*This API is unstable and requires `--cfg=web_sys_unstable_apis` to be activated, as"]
    #[doc = "[described in the `wasm-bindgen` guide](https://wasm-bindgen.github.io/wasm-bindgen/web-sys/unstable-apis.html)*"]
    #[wasm_bindgen(method, getter = "platformVersion")]
    pub fn get_platform_version_js_string(this: &UaDataValues) -> Option<::js_sys::JsString>;
    #[cfg(web_sys_unstable_apis)]
