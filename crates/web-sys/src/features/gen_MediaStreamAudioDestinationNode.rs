...
impl ::wasm_bindgen::convert::Upcast<AudioNode> for MediaStreamAudioDestinationNode {}
#[automatically_derived]
impl ::wasm_bindgen::convert::Upcast<EventTarget> for MediaStreamAudioDestinationNode {}
