...
extern "C" {
    ...
    #[doc = "*This API requires the following crate features to be activated: `MessageEventInit`*"]
    #[wasm_bindgen(method, getter = "lastEventId")]
    pub fn get_last_event_id_js_string(this: &MessageEventInit) -> Option<::js_sys::JsString>;
    ...
    #[doc = "*This API requires the following crate features to be activated: `MessageEventInit`*"]
    #[wasm_bindgen(method, getter = "origin")]
    pub fn get_origin_js_string(this: &MessageEventInit) -> Option<::js_sys::JsString>;
