...
extern "C" {
    ...
    #[doc = "*This API is unstable and requires `--cfg=web_sys_unstable_apis` to be activated, as"]
    #[doc = "[described in the `wasm-bindgen` guide](https://wasm-bindgen.github.io/wasm-bindgen/web-sys/unstable-apis.html)*"]
    pub fn title_js_string(this: &MediaMetadata) -> ::js_sys::JsString;
    #[cfg(web_sys_unstable_apis)]
    ...
    #[cfg(web_sys_unstable_apis)]
    #[wasm_bindgen(method, getter, js_class = "MediaMetadata", js_name = "artist")]
    #[doc = "Like `artist()`, but returning a `js_sys::JsString` handle to the string rather than copying it into wasm memory."]
    #[doc = ""]
    #[doc = "[MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/API/MediaMetadata/artist)"]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `MediaMetadata`*"]
    ...
    #[doc = "*This API is unstable and requires `--cfg=web_sys_unstable_apis` to be activated, as"]
    #[doc = "[described in the `wasm-bindgen` guide](https://wasm-bindgen.github.io/wasm-bindgen/web-sys/unstable-apis.html)*"]
    pub fn artist_js_string(this: &MediaMetadata) -> ::js_sys::JsString;
    #[cfg(web_sys_unstable_apis)]
    ...
    #[cfg(web_sys_unstable_apis)]
    #[wasm_bindgen(method, getter, js_class = "MediaMetadata", js_name = "album")]
    #[doc = "Like `album()`, but returning a `js_sys::JsString` handle to the string rather than copying it into wasm memory."]
    #[doc = ""]
    #[doc = "[MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/API/MediaMetadata/album)"]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `MediaMetadata`*"]
    ...
    #[doc = "*This API is unstable and requires `--cfg=web_sys_unstable_apis` to be activated, as"]
    #[doc = "[described in the `wasm-bindgen` guide](https://wasm-bindgen.github.io/wasm-bindgen/web-sys/unstable-apis.html)*"]
    pub fn album_js_string(this: &MediaMetadata) -> ::js_sys::JsString;
    #[cfg(web_sys_unstable_apis)]
