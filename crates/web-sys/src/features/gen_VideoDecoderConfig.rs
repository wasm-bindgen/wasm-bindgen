...
extern "C" {
    ...
    #[doc = "[described in the `wasm-bindgen` guide](https://wasm-bindgen.github.io/wasm-bindgen/web-sys/unstable-apis.html)*"]
    #[wasm_bindgen(method, getter = "codec")]
    pub fn get_codec_js_string(this: &VideoDecoderConfig) -> ::js_sys::JsString;
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn set_codec<S0: ::wasm_bindgen::JsStringLike>(this: &VideoDecoderConfig, val: S0);
    #[cfg(web_sys_unstable_apis)]
...
impl VideoDecoderConfig {
    ...
    #[doc = "*This API is unstable and requires `--cfg=web_sys_unstable_apis` to be activated, as"]
    #[doc = "[described in the `wasm-bindgen` guide](https://wasm-bindgen.github.io/wasm-bindgen/web-sys/unstable-apis.html)*"]
    pub fn new<S0: ::wasm_bindgen::JsStringLike>(codec: S0) -> Self {
        #[allow(unused_mut)]
