...
extern "C" {
    ...
    #[doc = "Like `get_cname()`, but returning a `js_sys::JsString` handle to the string rather than copying it into wasm memory."]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `RtcRtcpParameters`*"]
    #[wasm_bindgen(method, getter = "cname")]
    pub fn get_cname_js_string(this: &RtcRtcpParameters) -> Option<::js_sys::JsString>;
