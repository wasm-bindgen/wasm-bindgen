...
extern "C" {
    ...
    #[doc = "Like `get_channels()`, but returning a `js_sys::JsString` handle to the string rather than copying it into wasm memory."]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `AudioConfiguration`*"]
    #[wasm_bindgen(method, getter = "channels")]
    pub fn get_channels_js_string(this: &AudioConfiguration) -> Option<::js_sys::JsString>;
    ...
    #[doc = "*This API requires the following crate features to be activated: `AudioConfiguration`*"]
    #[wasm_bindgen(method, getter = "contentType")]
    pub fn get_content_type_js_string(this: &AudioConfiguration) -> Option<::js_sys::JsString>;
