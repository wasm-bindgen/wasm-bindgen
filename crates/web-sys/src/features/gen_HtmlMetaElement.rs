...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `HtmlMetaElement`*"]
    pub fn set_name_js_string(this: &HtmlMetaElement, value: &::js_sys::JsString);
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `HtmlMetaElement`*"]
    pub fn set_http_equiv_js_string(this: &HtmlMetaElement, value: &::js_sys::JsString);
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `HtmlMetaElement`*"]
    pub fn set_content_js_string(this: &HtmlMetaElement, value: &::js_sys::JsString);
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `HtmlMetaElement`*"]
    pub fn set_scheme_js_string(this: &HtmlMetaElement, value: &::js_sys::JsString);
}
