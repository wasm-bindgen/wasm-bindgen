...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `CustomEvent`*"]
    pub fn new_with_js_string(type_: &::js_sys::JsString) -> Result<CustomEvent, JsValue>;
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `CustomEvent`*"]
    pub fn init_custom_event_with_js_string(this: &CustomEvent, type_: &::js_sys::JsString);
    #[wasm_bindgen(method, js_class = "CustomEvent", js_name = "initCustomEvent")]
    #[doc = "The `initCustomEvent()` method."]
    #[doc = ""]
    #[doc = "[MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/API/CustomEvent/initCustomEvent)"]
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `CustomEvent`*"]
    pub fn init_custom_event_with_js_string_and_can_bubble(
        this: &CustomEvent,
        type_: &::js_sys::JsString,
        can_bubble: bool,
    );
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `CustomEvent`*"]
    pub fn init_custom_event_with_js_string_and_can_bubble_and_cancelable(
        this: &CustomEvent,
        type_: &::js_sys::JsString,
        can_bubble: bool,
        cancelable: bool,
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `CustomEvent`*"]
    pub fn init_custom_event_with_js_string_and_can_bubble_and_cancelable_and_detail(
        this: &CustomEvent,
        type_: &::js_sys::JsString,
        can_bubble: bool,
        cancelable: bool,
