...
extern "C" {
    ...
    #[doc = "[described in the `wasm-bindgen` guide](https://wasm-bindgen.github.io/wasm-bindgen/web-sys/unstable-apis.html)*"]
    #[wasm_bindgen(method, getter = "description")]
    pub fn get_description_js_string(this: &FilePickerAcceptType) -> Option<::js_sys::JsString>;
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn set_description<S0: ::wasm_bindgen::JsStringLike>(this: &FilePickerAcceptType, val: S0);
}
#[cfg(web_sys_unstable_apis)]
impl FilePickerAcceptType {
    ...
    pub fn description<S0: ::wasm_bindgen::JsStringLike>(&mut self, val: S0) -> &mut Self {
