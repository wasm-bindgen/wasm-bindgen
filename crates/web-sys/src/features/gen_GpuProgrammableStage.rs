...
extern "C" {
    ...
    #[doc = "[described in the `wasm-bindgen` guide](https://wasm-bindgen.github.io/wasm-bindgen/web-sys/unstable-apis.html)*"]
    #[wasm_bindgen(method, getter = "entryPoint")]
    pub fn get_entry_point_js_string(this: &GpuProgrammableStage) -> Option<::js_sys::JsString>;
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn set_entry_point<S0: ::wasm_bindgen::JsStringLike>(this: &GpuProgrammableStage, val: S0);
    #[cfg(web_sys_unstable_apis)]
