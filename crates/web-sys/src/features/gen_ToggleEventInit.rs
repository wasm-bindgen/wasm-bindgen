...
extern "C" {
    ...
    #[doc = "Like `get_new_state()`, but returning a `js_sys::JsString` handle to the string rather than copying it into wasm memory."]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `ToggleEventInit`*"]
    #[wasm_bindgen(method, getter = "newState")]
    pub fn get_new_state_js_string(this: &ToggleEventInit) -> Option<::js_sys::JsString>;
    ...
    #[doc = "Like `get_old_state()`, but returning a `js_sys::JsString` handle to the string rather than copying it into wasm memory."]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `ToggleEventInit`*"]
    #[wasm_bindgen(method, getter = "oldState")]
    pub fn get_old_state_js_string(this: &ToggleEventInit) -> Option<::js_sys::JsString>;
