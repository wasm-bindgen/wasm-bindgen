...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `HtmlParamElement`*"]
    pub fn set_name_js_string(this: &HtmlParamElement, value: &::js_sys::JsString);
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `HtmlParamElement`*"]
    pub fn set_value_js_string(this: &HtmlParamElement, value: &::js_sys::JsString);
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `HtmlParamElement`*"]
    pub fn set_type_js_string(this: &HtmlParamElement, value: &::js_sys::JsString);
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `HtmlParamElement`*"]
    pub fn set_value_type_js_string(this: &HtmlParamElement, value: &::js_sys::JsString);
}
