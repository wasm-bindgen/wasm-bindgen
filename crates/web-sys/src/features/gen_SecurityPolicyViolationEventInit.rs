...
extern "C" {
    ...
    #[doc = "Like `get_blocked_uri()`, but returning a `js_sys::JsString` handle to the string rather than copying it into wasm memory."]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `SecurityPolicyViolationEventInit`*"]
    #[wasm_bindgen(method, getter = "blockedURI")]
    pub fn get_blocked_uri_js_string(
        this: &SecurityPolicyViolationEventInit,
    ...
    #[doc = "Like `get_document_uri()`, but returning a `js_sys::JsString` handle to the string rather than copying it into wasm memory."]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `SecurityPolicyViolationEventInit`*"]
    #[wasm_bindgen(method, getter = "documentURI")]
    pub fn get_document_uri_js_string(
        this: &SecurityPolicyViolationEventInit,
    ) -> Option<::js_sys::JsString>;
    ...
    #[doc = "Like `get_effective_directive()`, but returning a `js_sys::JsString` handle to the string rather than copying it into wasm memory."]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `SecurityPolicyViolationEventInit`*"]
    #[wasm_bindgen(method, getter = "effectiveDirective")]
    pub fn get_effective_directive_js_string(
        this: &SecurityPolicyViolationEventInit,
    ) -> Option<::js_sys::JsString>;
    ...
    #[doc = "Like `get_original_policy()`, but returning a `js_sys::JsString` handle to the string rather than copying it into wasm memory."]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `SecurityPolicyViolationEventInit`*"]
    #[wasm_bindgen(method, getter = "originalPolicy")]
    pub fn get_original_policy_js_string(
        this: &SecurityPolicyViolationEventInit,
    ) -> Option<::js_sys::JsString>;
    ...
    #[doc = "Like `get_sample()`, but returning a `js_sys::JsString` handle to the string rather than copying it into wasm memory."]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `SecurityPolicyViolationEventInit`*"]
    #[wasm_bindgen(method, getter = "sample")]
    pub fn get_sample_js_string(
        this: &SecurityPolicyViolationEventInit,
    ) -> Option<::js_sys::JsString>;
    ...
    #[doc = "Like `get_source_file()`, but returning a `js_sys::JsString` handle to the string rather than copying it into wasm memory."]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `SecurityPolicyViolationEventInit`*"]
    #[wasm_bindgen(method, getter = "sourceFile")]
    pub fn get_source_file_js_string(
        this: &SecurityPolicyViolationEventInit,
    ) -> Option<::js_sys::JsString>;
    ...
    #[doc = "Like `get_violated_directive()`, but returning a `js_sys::JsString` handle to the string rather than copying it into wasm memory."]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `SecurityPolicyViolationEventInit`*"]
    #[wasm_bindgen(method, getter = "violatedDirective")]
    pub fn get_violated_directive_js_string(
        this: &SecurityPolicyViolationEventInit,
    ) -> Option<::js_sys::JsString>;
