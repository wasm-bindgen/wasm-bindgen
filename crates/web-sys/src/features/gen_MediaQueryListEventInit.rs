...
extern "C" {
    ...
    #[doc = "Like `get_media()`, but returning a `js_sys::JsString` handle to the string rather than copying it into wasm memory."]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `MediaQueryListEventInit`*"]
    #[wasm_bindgen(method, getter = "media")]
    pub fn get_media_js_string(this: &MediaQueryListEventInit) -> Option<::js_sys::JsString>;
