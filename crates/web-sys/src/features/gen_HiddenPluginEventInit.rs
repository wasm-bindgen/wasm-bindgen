...
extern "C" {
    ...
    pub fn set_bubbles(this: &HiddenPluginEventInit, val: bool);
    ...
    pub fn set_cancelable(this: &HiddenPluginEventInit, val: bool);
    ...
    pub fn set_composed(this: &HiddenPluginEventInit, val: bool);
}
