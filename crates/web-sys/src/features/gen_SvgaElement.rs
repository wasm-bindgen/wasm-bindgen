...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `SvgaElement`*"]
    pub fn set_download_js_string(this: &SvgaElement, value: &::js_sys::JsString);
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `SvgaElement`*"]
    pub fn set_ping_js_string(this: &SvgaElement, value: &::js_sys::JsString);
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `SvgaElement`*"]
    pub fn set_rel_js_string(this: &SvgaElement, value: &::js_sys::JsString);
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `SvgaElement`*"]
    pub fn set_referrer_policy_js_string(this: &SvgaElement, value: &::js_sys::JsString);
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `SvgaElement`*"]
    pub fn set_hreflang_js_string(this: &SvgaElement, value: &::js_sys::JsString);
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `SvgaElement`*"]
    pub fn set_type_js_string(this: &SvgaElement, value: &::js_sys::JsString);
