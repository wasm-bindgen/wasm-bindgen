...
extern "C" {
    ...
    #[doc = "Like `get_address_type()`, but returning a `js_sys::JsString` handle to the string rather than copying it into wasm memory."]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `AutocompleteInfo`*"]
    #[wasm_bindgen(method, getter = "addressType")]
    pub fn get_address_type_js_string(this: &AutocompleteInfo) -> Option<::js_sys::JsString>;
    ...
    #[doc = "Like `get_contact_type()`, but returning a `js_sys::JsString` handle to the string rather than copying it into wasm memory."]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `AutocompleteInfo`*"]
    #[wasm_bindgen(method, getter = "contactType")]
    pub fn get_contact_type_js_string(this: &AutocompleteInfo) -> Option<::js_sys::JsString>;
    ...
    #[doc = "Like `get_field_name()`, but returning a `js_sys::JsString` handle to the string rather than copying it into wasm memory."]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `AutocompleteInfo`*"]
    #[wasm_bindgen(method, getter = "fieldName")]
    pub fn get_field_name_js_string(this: &AutocompleteInfo) -> Option<::js_sys::JsString>;
    ...
    #[doc = "Like `get_section()`, but returning a `js_sys::JsString` handle to the string rather than copying it into wasm memory."]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `AutocompleteInfo`*"]
    #[wasm_bindgen(method, getter = "section")]
    pub fn get_section_js_string(this: &AutocompleteInfo) -> Option<::js_sys::JsString>;
