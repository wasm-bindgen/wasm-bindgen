...
extern "C" {
    ...
    #[doc = "*This API requires the following crate features to be activated: `RtcRtpCodecParameters`*"]
    #[wasm_bindgen(method, getter = "mimeType")]
    pub fn get_mime_type_js_string(this: &RtcRtpCodecParameters) -> Option<::js_sys::JsString>;
    ...
    #[doc = "*This API requires the following crate features to be activated: `RtcRtpCodecParameters`*"]
    #[wasm_bindgen(method, getter = "sdpFmtpLine")]
    pub fn get_sdp_fmtp_line_js_string(this: &RtcRtpCodecParameters) -> Option<::js_sys::JsString>;
