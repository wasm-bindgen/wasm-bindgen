...
extern "C" {
    ...
    #[doc = "[described in the `wasm-bindgen` guide](https://wasm-bindgen.github.io/wasm-bindgen/web-sys/unstable-apis.html)*"]
    #[wasm_bindgen(method, getter = "label")]
    pub fn get_label_js_string(this: &GpuCommandEncoderDescriptor) -> Option<::js_sys::JsString>;
    #[cfg(web_sys_unstable_apis)]
    ...
    pub fn set_label<S0: ::wasm_bindgen::JsStringLike>(this: &GpuCommandEncoderDescriptor, val: S0);
}
#[cfg(web_sys_unstable_apis)]
