...
extern "C" {
    ...
    #[doc = "Like `get_protocol_version()`, but returning a `js_sys::JsString` handle to the string rather than copying it into wasm memory."]
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `HttpConnInfo`*"]
    #[wasm_bindgen(method, getter = "protocolVersion")]
    pub fn get_protocol_version_js_string(this: &HttpConnInfo) -> Option<::js_sys::JsString>;
