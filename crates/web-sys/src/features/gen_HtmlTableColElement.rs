...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `HtmlTableColElement`*"]
    pub fn set_align_js_string(this: &HtmlTableColElement, value: &::js_sys::JsString);
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `HtmlTableColElement`*"]
    pub fn set_ch_js_string(this: &HtmlTableColElement, value: &::js_sys::JsString);
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `HtmlTableColElement`*"]
    pub fn set_ch_off_js_string(this: &HtmlTableColElement, value: &::js_sys::JsString);
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `HtmlTableColElement`*"]
    pub fn set_v_align_js_string(this: &HtmlTableColElement, value: &::js_sys::JsString);
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `HtmlTableColElement`*"]
    pub fn set_width_js_string(this: &HtmlTableColElement, value: &::js_sys::JsString);
}
