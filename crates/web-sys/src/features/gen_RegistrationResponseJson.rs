...
extern "C" {
    ...
    #[doc = "[described in the `wasm-bindgen` guide](https://wasm-bindgen.github.io/wasm-bindgen/web-sys/unstable-apis.html)*"]
    #[wasm_bindgen(method, getter = "id")]
    pub fn get_id_js_string(this: &RegistrationResponseJson) -> ::js_sys::JsString;
    #[cfg(web_sys_unstable_apis)]
    ...
    #[doc = "[described in the `wasm-bindgen` guide](https://wasm-bindgen.github.io/wasm-bindgen/web-sys/unstable-apis.html)*"]
    #[wasm_bindgen(method, getter = "rawId")]
    pub fn get_raw_id_js_string(this: &RegistrationResponseJson) -> ::js_sys::JsString;
    #[cfg(web_sys_unstable_apis)]
    ...
    #[doc = "[described in the `wasm-bindgen` guide](https://wasm-bindgen.github.io/wasm-bindgen/web-sys/unstable-apis.html)*"]
    #[wasm_bindgen(method, getter = "type")]
    pub fn get_type_js_string(this: &RegistrationResponseJson) -> ::js_sys::JsString;
    #[cfg(web_sys_unstable_apis)]
