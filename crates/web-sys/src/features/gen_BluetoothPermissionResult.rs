...
impl ::wasm_bindgen::convert::Upcast<PermissionStatus> for BluetoothPermissionResult {}
#[cfg(web_sys_unstable_apis)]
#[automatically_derived]
impl ::wasm_bindgen::convert::Upcast<EventTarget> for BluetoothPermissionResult {}
