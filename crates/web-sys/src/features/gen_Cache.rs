...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `Cache`*"]
    pub fn add_with_js_string(this: &Cache, request: &::js_sys::JsString) -> ::js_sys::Promise;
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `Cache`*"]
    pub fn delete_with_js_string(this: &Cache, request: &::js_sys::JsString) -> ::js_sys::Promise;
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `Cache`, `CacheQueryOptions`*"]
    pub fn delete_with_js_string_and_options(
        this: &Cache,
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `Cache`*"]
    pub fn keys_with_js_string(this: &Cache, request: &::js_sys::JsString) -> ::js_sys::Promise;
    #[cfg(all(feature = "CacheQueryOptions", feature = "Request",))]
    #[wasm_bindgen(method, js_class = "Cache", js_name = "keys")]
    #[doc = "The `keys()` method."]
    #[doc = ""]
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `Cache`, `CacheQueryOptions`*"]
    pub fn keys_with_js_string_and_options(
        this: &Cache,
        request: &::js_sys::JsString,
        options: &CacheQueryOptions,
    ) -> ::js_sys::Promise;
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `Cache`*"]
    pub fn match_with_js_string(this: &Cache, request: &::js_sys::JsString) -> ::js_sys::Promise;
    #[cfg(all(feature = "CacheQueryOptions", feature = "Request",))]
    #[wasm_bindgen(method, js_class = "Cache", js_name = "match")]
    #[doc = "The `match()` method."]
    #[doc = ""]
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `Cache`*"]
    pub fn match_all_with_js_string(
        this: &Cache,
        request: &::js_sys::JsString,
    ) -> ::js_sys::Promise;
    #[cfg(all(feature = "CacheQueryOptions", feature = "Request",))]
    ...
    #[doc = ""]
    #[doc = "*This API requires the following crate features to be activated: `Cache`, `CacheQueryOptions`*"]
    pub fn match_all_with_js_string_and_options(
        this: &Cache,
        request: &::js_sys::JsString,
        options: &CacheQueryOptions,
    ) -> ::js_sys::Promise;
