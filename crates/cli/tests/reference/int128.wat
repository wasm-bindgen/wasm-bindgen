(module $int128_reftest.wasm
  ...
  (func $"echo_option_i128 multivalue shim" (;4;) (type 4) (param i32 i64 i64) (result i32 i64 i64))
  (func $"echo_option_u128 multivalue shim" (;5;) (type 4) (param i32 i64 i64) (result i32 i64 i64))
