(module $getter_setter_reftest.wasm
  ...
  (func $__wbg_foo_free (;2;) (type 1) (param i32 i32))
  (func $__wbg_get_foo_x (;3;) (type 3) (param i32) (result i32))
  (func $__wbg_get_foo_y (;4;) (type 7) (param i32) (result f64))
  (func $__wbg_set_foo_x (;5;) (type 1) (param i32 i32))
  (func $__wbg_set_foo_y (;6;) (type 5) (param i32 f64))
  (func $foo_lone_getter (;7;) (type 7) (param i32) (result f64))
  (func $foo_set_lone_setter (;8;) (type 5) (param i32 f64))
  (func $foo_set_weird (;9;) (type 6) (param i32 i32 i32))
  (func $foo_set_x_static (;10;) (type 0) (param i32))
  (func $foo_set_z (;11;) (type 5) (param i32 f64))
  (func $foo_weird (;12;) (type 3) (param i32) (result i32))
  (func $foo_x_static (;13;) (type 4) (result i32))
  (func $foo_z (;14;) (type 7) (param i32) (result f64))
  (func $__wbindgen_malloc (;15;) (type 2) (param i32 i32) (result i32))
  (func $__wbindgen_realloc (;16;) (type 9) (param i32 i32 i32 i32) (result i32))
