...
/**
 * @param {Renamed[]} renameds
 * @returns {number}
 */
export function readRenameds(renameds) {
    const ptr0 = passArrayJsValueToWasm0(renameds, wasm.__wbindgen_malloc);
...
export function __wbg_renamed_unwrap(arg0) {
    const ret = Renamed.__unwrap(arg0);
    return ret;
}
