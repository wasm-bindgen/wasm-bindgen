(module $reference_test.wasm
  ...
  (func $"get_url externref shim" (;1;) (type 2) (result externref))
  (func $get_media_source (;2;) (type 1) (result i32))
  ...
  (func $__wbindgen_realloc (;6;) (type 5) (param i32 i32 i32 i32) (result i32))
