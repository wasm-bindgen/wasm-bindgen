(module $reference_test.wasm
  ...
  (func $get_media_source (;1;) (type 1) (result i32))
  (func $__wbindgen_realloc (;2;) (type 5) (param i32 i32 i32 i32) (result i32))
  (func $__wbindgen_exn_store (;3;) (type 3) (param i32))
  (func $__wbindgen_malloc (;4;) (type 4) (param i32 i32) (result i32))
  (func $"get_url externref shim" (;5;) (type 2) (result externref))
  (func $__externref_table_alloc (;6;) (type 1) (result i32))
