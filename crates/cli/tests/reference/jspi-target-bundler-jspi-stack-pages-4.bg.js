...
export function do_work() {
    ...
    const __jspi_stack = __jspi_stack_alloc();
    wasm.__stack_pointer.value = __jspi_stack + __jspi_stack_size;
    return (__wbg_jspi_do_work ??= WebAssembly.promising(wasm.do_work))().finally(() => { wasm.__stack_pointer.value = __jspi_sync_sp; __jspi_stack_free(__jspi_stack); });
}
