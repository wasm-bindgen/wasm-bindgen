(module $self_type_reftest.wasm
  ...
  (func $test_new (;3;) (type 1) (result i32))
  (func $test_consume_self (;4;) (type 2) (param i32))
  (func $test_ref_self (;5;) (type 2) (param i32))
  (func $test_ref_mut_self (;6;) (type 2) (param i32))
