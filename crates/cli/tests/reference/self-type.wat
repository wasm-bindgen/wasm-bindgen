(module $self_type_reftest.wasm
  ...
  (func $__wbg_test_free (;2;) (type 1) (param i32 i32))
  (func $test_consume_self (;3;) (type 0) (param i32))
  (func $test_new (;4;) (type 3) (result i32))
  (func $test_ref_mut_self (;5;) (type 0) (param i32))
  (func $test_ref_self (;6;) (type 0) (param i32))
  (func $test_self_Self (;7;) (type 0) (param i32))
  (func $test_self_ref_Self (;8;) (type 0) (param i32))
  (func $test_self_ref_mut_Self (;9;) (type 0) (param i32))
