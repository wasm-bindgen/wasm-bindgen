...
intrinsics! {
    pub enum Intrinsic {
        ...
        NumberNew = "__wbindgen_number_new",
        BigIntFromI64 = "__wbindgen_bigint_from_i64",
        BigIntFromU64 = "__wbindgen_bigint_from_u64",
        BigIntFromI128 = "__wbindgen_bigint_from_i128",
        BigIntFromU128 = "__wbindgen_bigint_from_u128",
        StringNew = "__wbindgen_string_new",
        ...
        Uint8ArrayNew = "__wbindgen_uint8_array_new",
        Uint8ClampedArrayNew = "__wbindgen_uint8_clamped_array_new",
        Uint16ArrayNew = "__wbindgen_uint16_array_new",
        Uint32ArrayNew = "__wbindgen_uint32_array_new",
        BigUint64ArrayNew = "__wbindgen_biguint64_array_new",
        Int8ArrayNew = "__wbindgen_int8_array_new",
        Int16ArrayNew = "__wbindgen_int16_array_new",
        Int32ArrayNew = "__wbindgen_int32_array_new",
        BigInt64ArrayNew = "__wbindgen_bigint64_array_new",
        Float32ArrayNew = "__wbindgen_float32_array_new",
        Float64ArrayNew = "__wbindgen_float64_array_new",
        ArrayNew = "__wbindgen_array_new",
        ArrayPush = "__wbindgen_array_push",
