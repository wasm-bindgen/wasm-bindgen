...
intrinsics! {
    pub enum Intrinsic {
        ...
        NumberNewIntoSlot = "__wbindgen_number_new_into_slot",
        ResetSlots = "__wbindgen_reset_slots",
        CharNewIntoSlot = "__wbindgen_char_new_into_slot",
        BigintNewIntoSlot = "__wbindgen_bigint_new_into_slot",
