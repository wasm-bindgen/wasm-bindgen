...
/// BoundedFunction is an alias type for functions with strict arg count
/// checking.
///
...
extern "C" {
    ...
    // Next major: deprecate and rename over create
    /// The `Object.create()` method creates a new object, using an existing
    /// object to provide the newly created object's prototype.
    ///
    /// [MDN documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object/create)
    #[wasm_bindgen(static_method_of = Object, catch)]
    pub fn create_typed<T, U>(prototype: &Object<T>) -> Result<Object<U>, JsValue>;
...
extern "C" {
    ...
    pub fn catch_map<T, U: ErasableGeneric, R: Promising<Resolution = U>>(
        this: &Promise<T>,
    ...
    // Next major: finally_map for finally, deprecate finally_map
    ...
    /// [MDN documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise/finally)
    #[wasm_bindgen(method)]
    pub fn finally_map<T, U: ErasableGeneric, R: Promising<Resolution = U>>(
        this: &Promise<T>,
        cb: &Closure<dyn FnMut() -> Result<R, JsValue>>,
    ) -> Promise<U>;
}
