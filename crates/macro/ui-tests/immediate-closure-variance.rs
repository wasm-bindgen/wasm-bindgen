...
fn main() {
    ...
    let immediate: ImmediateClosure<dyn FnMut() -> u32> = ImmediateClosure::new(&mut closure);
    ...
    let immediate2: ImmediateClosure<dyn FnMut(Number)> = ImmediateClosure::new(&mut closure2);
