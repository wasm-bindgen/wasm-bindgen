...
#[cfg(all(feature = "std", all(target_family = "wasm", not(target_os = "wasi")), panic = "unwind"))]
...
#[cfg(not(all(feature = "std", all(target_family = "wasm", not(target_os = "wasi")), panic = "unwind")))]
