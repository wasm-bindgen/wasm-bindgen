...
/// that the ErasableGeneric property that the repr of the type is the type
...
pub trait ErasableGenericBorrow<ConcreteTarget: ?Sized> {}

#[cfg_attr(wbg_diagnostic, diagnostic::do_not_recommend)]
impl<'a, T: ?Sized, ConcreteTarget: ?Sized> ErasableGenericBorrow<ConcreteTarget> for T
where
    &'a ConcreteTarget: ErasableGeneric + 'a,
    &'a T: ErasableGeneric<Repr = <&'a ConcreteTarget as ErasableGeneric>::Repr> + 'a,
{
}
...
#[cfg_attr(wbg_diagnostic, diagnostic::do_not_recommend)]
impl<'a, T: ?Sized, ConcreteTarget: ?Sized> ErasableGenericBorrowMut<ConcreteTarget> for T
where
    &'a mut ConcreteTarget: ErasableGeneric + 'a,
    &'a mut T: ErasableGeneric<Repr = <&'a mut ConcreteTarget as ErasableGeneric>::Repr> + 'a,
{
}
