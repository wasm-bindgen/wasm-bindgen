...
pub trait FromWasmAbi: WasmDescribe {
    ...
    unsafe fn from_abi_prims(
        prim1: <Self::Abi as WasmAbi>::Prim1,
        prim2: <Self::Abi as WasmAbi>::Prim2,
        prim3: <Self::Abi as WasmAbi>::Prim3,
        prim4: <Self::Abi as WasmAbi>::Prim4,
    ) -> Self
    where
        Self: Sized,
    {
        Self::from_abi(Self::Abi::join(prim1, prim2, prim3, prim4))
    }
}
